...
public class Journey {
    ...
    public Journey(final String stationFrom, final String stationTo, final LocalDate departure,
        ...
        if (stationTo == null) throw new IllegalArgumentException("station from must be set!");
        if (departure == null) throw new IllegalArgumentException("station from must be set!");
        if (arrival == null) throw new IllegalArgumentException("station from must be set!");
